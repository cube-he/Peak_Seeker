...
- **产物**：`data/_pipeline/P1/03_patched.xlsx` (rows=48131)
- **日志**：`data/_pipeline/P1/patch_log.csv` (entries=2)
- **未解决**：`data/_pipeline/P1/unresolvable.csv` (entries=2)
...
- 2 条未解决（类型分布见 `unresolvable.csv`），将在 P2 阶段用 01 反查修复

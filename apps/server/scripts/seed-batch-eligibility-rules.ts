...
// 2026 军队院校招生公告 (Newsdetail_4851, 含面试体检注意事项): 比 4815 政考通知更全, 覆盖面试体检时间地点/录取/注意事项
const ref_sceea_2026_junxiao_gonggao = {
  title: '四川教育考试院 2026 军队院校招生公告 (含面试体检, 官网)',
  filename: null,
  externalUrl: 'https://www.sceea.cn/Html/202606/Newsdetail_4851.html',
  type: 'announcement' as const,
};
    ...
    subsets: [
      {
        ...
        references: [
          ...
          ref_sceea_2026_junxiao_gonggao,
          ref_zhaosheng_wuli,
        ],
      },
      {

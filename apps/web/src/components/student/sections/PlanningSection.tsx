  ...
  return (
    <Form layout="horizontal" labelCol={{ span: 8 }} wrapperCol={{ span: 16 }} size="small">
      <Row gutter={[16, 0]}>
        ...
        <Col xs={12} md={6}><Form.Item label="中外合作"><AutoSaveSwitch fieldKey="acceptSinoForeign" defaultValue={profile.acceptSinoForeign} /></Form.Item></Col>
        ...
        <Col xs={24}><Form.Item label="兴趣爱好" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}><AutoSaveSelect fieldKey="interests" defaultValue={profile.interests ?? []} mode="tags" placeholder="回车添加兴趣标签" /></Form.Item></Col>

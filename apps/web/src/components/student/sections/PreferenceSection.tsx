  ...
  return (
    <Form layout="horizontal" labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} size="small">
      <Row gutter={[16, 0]}>
        ...
        <Col xs={24}><Form.Item label="意向标签" labelCol={{ span: 3 }} wrapperCol={{ span: 21 }}><AutoSaveSelect fieldKey="preferredTags" defaultValue={profile.preferredTags ?? []} mode="tags" placeholder="自由输入后回车添加" /></Form.Item></Col>
